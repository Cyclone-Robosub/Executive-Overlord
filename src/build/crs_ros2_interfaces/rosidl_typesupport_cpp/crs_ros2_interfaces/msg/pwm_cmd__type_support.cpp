...
static const _PwmCmd_type_support_symbol_names_t _PwmCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crs_ros2_interfaces, msg, PwmCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crs_ros2_interfaces, msg, PwmCmd)),
  }
};
...
{
  return &::crs_ros2_interfaces::msg::rosidl_typesupport_cpp::PwmCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, crs_ros2_interfaces, msg, PwmCmd)() {
  return get_message_type_support_handle<crs_ros2_interfaces::msg::PwmCmd>();
}
