...
static const _PwmCmd_type_support_symbol_names_t _PwmCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crs_ros2_interfaces, msg, PwmCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crs_ros2_interfaces, msg, PwmCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, crs_ros2_interfaces, msg, PwmCmd)() {
  return &::crs_ros2_interfaces::msg::rosidl_typesupport_c::PwmCmd_message_type_support_handle;
}
